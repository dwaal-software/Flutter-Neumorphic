...
class __PageState extends State<_Page> {
                  ...
                  child: ElevatedButton(
                    style: ButtonStyle(
                      ...
                      backgroundColor: selectedConfiguratorIndex == 0
                          ? MaterialStateProperty.all<Color>(buttonActiveColor)
  ...
  Widget neumorphic() {
    return NeumorphicButton(
      ...
      drawSurfaceAboveChild: drawAboveChild ?? false,
      ...
      child: SizedBox(
        height: height,
        width: width,
        child: haveNeumorphicChild ?? false
            ? neumorphicChild()
            : Container(
                //color: Colors.blue,
  ...
  Widget neumorphicChild() {
    return Neumorphic(
      ...
      style: NeumorphicStyle(
          ...
          depth: childDepth,
          lightSource: lightSource,
          oppositeShadowLightSource: childOppositeLightsourceChild ?? false),
            ...
            child: ElevatedButton(
              style: ButtonStyle(
                ...
                backgroundColor: boxShape.isRoundRect
                    ? MaterialStateProperty.all<Color>(buttonActiveColor)
                    : MaterialStateProperty.all<Color>(buttonInnactiveColor),
              ),
              onPressed: () {
                setState(() {
                  boxShape = NeumorphicBoxShape.roundRect(
